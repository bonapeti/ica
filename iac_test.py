...
def test_diff_with_file(cli_runner, monkeypatch):
    ...
    with monkeypatch.context() as m:
        m.setattr(cloud.azure.api, "login", mocklogin)
        m.setattr(cloud.azure.api, "get_resources", mockget_resources)
...
""")
        ...
        with cloud.azure.api.login() as credential:
            resource_dict = cloud.azure.api.get_resources(credential, TEST_SUBSCRIPTION_ID)
